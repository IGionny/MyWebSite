<template>
  <div class="flex-1 p-1 h-auto text-green-200 font-mono text-md bg-black" id="section-summary">
    <pre class="pb-1">
   ___ _                             _ 
...
\____/|_|\___/ \_/ \__,_|_| |_|_| |_|_|
    ...
    <p class="pb-1">Last login: Sun Gen 2024 14 17:20:04 on ttys002</p>
    ...
    <p class="pb-1">
      ...
      , VueJs 3, Vite, GitHub pages.
    </p>
    <p class="pt-2 pb-1">
      In my daily job time, I develop my Web Applications with the power of <u>C#/.Net Core</u>, <u>VueJs 2 (3 see you
      soon..)</u>, <u>WebPack</u>, <u>PostgreSQL</u>, <u>Elastic Search</u>, <u>Active Directory</u>, <u>Azure A.D.</u>
      (and many other nerdies™) and I deploy them with a lot of love made in <u>Docker</u>
      <font-awesome-icon icon="fa-brands fa-docker" class="text-blue-500"/>
      .
    </p>
    <p class="pt-2 pb-1">
      My favourite developer tools are: <u>JetBrains Rider (IDE)</u>, <u>Total Commander</u>, <u>NotePad++</u>, <u>PgAdmin</u>,
      <u>Docker</u>.
    </p>
    ...
    <p class="pb-1">
      ...
      interests.
      <u>Miyazaki</u>'s films, especially "<u>Totoro</u>" hold a special place in my heart. Beyond that, I'm a tech
      enthusiast
    ...
    <div class="container flex flex-row items-stretch ">
      <div class="md:basis-1/2 p-4">
        <div class="text-blue-500 pl-4">
          <font-awesome-icon icon="fa-solid fa-server" class="mr-1"/>
          Server Side
        </div>
      ...
      <div class="md:basis-1/2 p-4">
        <div class="text-orange-1 pl-4">
          <font-awesome-icon icon="fa-brands fa-safari" class="mr-1"/>
          Front End
        </div>
        <div class="bg-gray-1 rounded-2xl p-4">
          <ul class="pt-1 flex flex-wrap text-sm gap-y-2 md:justify-start items-center font-karla">
    ...
    <div class="container flex flex-row items-stretch ">
      <div class="md:basis-1/2 p-4">
        <div class="text-blue-500 pl-4">
          <font-awesome-icon icon="fa-solid fa-cubes" class="mr-1"/>
