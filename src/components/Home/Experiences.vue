  ...
  <ol class="ml-2 relative border-s border-gray-200 dark:border-gray-700">
    <li class="mb-10 ms-4">
      ...
      <p class=" text-base font-normal text-gray-5">
        ...
        extends to Linux, DevOps, and Docker.
      </p>
      ...
      <p class="mb-4 text-base font-normal text-gray-5">My extensive testing practices ensure
        secure and continuous service for approximately 2k users.</p>
    </li>
    <li class="mb-10 ms-4">
      <div
          class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
      <time class="mb-1 text-sm font-normal leading-none  text-gray-5">2010 - 2017</time>
    ...
    <li class="ms-4">
      <div
          class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
      <time class="mb-1 text-sm font-normal leading-none  text-gray-5">2000 - 2014</time>
      ...
      <p class="text-base font-normal  text-gray-5">
        In my earlier role as a Web Developer from 2000 to 2003, I developed web portals and e-commerce sites,
        showcasing
        full-stack competencies in technologies such as Microsoft ASP Classic, Java JSP/Servlet, XML, HTML, CSS, and
        SQL.
      </p>
    </li>
  </ol>
