  ...
  <ol class="ml-2 relative border-s border-gray-200 dark:border-gray-700">
    <li class="mb-10 ms-4">
      ...
      <p class=" text-base font-normal text-gray-500 dark:text-gray-400">
        ...
        application
        security. Working on projects exclusively in <u>.NET Core</u>, <u>Typescript</u>, and <u>VueJS</u>, I've
      ...
      <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">My extensive testing practices ensure
